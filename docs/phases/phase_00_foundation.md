...
**Status**: `[x]` complete · **Effort**: 40h · **Completed**: 40h · **Progress**: 100%
...
| --------- | --------------------- | -------------------------------------------------------------------------------------- | -----: | ---------: | ---------- |
| 1         | Repo & Build Tooling  | [stage_01_repo_build_tooling.md](phase_00_foundation/stage_01_repo_build_tooling.md)   |      6 |         12 | `[x]`      |
| 2         | App Shell & Providers | [stage_02_app_shell_providers.md](phase_00_foundation/stage_02_app_shell_providers.md) |      5 |         14 | `[x]`      |
| 3         | CI & Docs             | [stage_03_ci_docs.md](phase_00_foundation/stage_03_ci_docs.md)                         |      6 |         14 | `[x]`      |
| **Total** |                       |                                                                                        | **17** |     **40** | `[x]` 100% |
